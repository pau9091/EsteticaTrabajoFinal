package com.example.esteticatrabajofinal.conexion.untils;
...
// Creamos la tabla usuarios
    public static final String CREAR_TABLA_USUARIO = "CREATE TABLE " + TABLA_USUARIO + " (" + CAMPO_ID_EMAIL + " TEXT UNIQUE PRIMARY KEY, " +
            CAMPO_PASSWORD + " TEXT, " +  CAMPO_NOMBRE + " TEXT, " +
            CAMPO_APELLIDO + " TEXT, " + CAMPO_FEC_NAC + " TEXT, " + CAMPO_TELEFONO + " TEXT)";
    ...
    // Creamos la tabla citas con su campo foraneo que es el correo
    public static final String CREAR_TABLA_CITAS = "CREATE TABLE " + TABLA_CITAS + " (" +
            CAMPO_ID_EMAIL + " TEXT, " + CAMPO_TIPO_SESION + " TEXT, " +
            CAMPO_FECHA_CITA + " TEXT UNIQUE, " + CAMPO_FECHA_AGENDA + " TIMESTAMP DEFAULT CURRENT_TIMESTAMP, " +
