...
public class ver_citas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        conn = new AdminSQLiteOpenHelper(getApplicationContext(),"bd_usuarios",null,1);
        ...
        if (checkDates()) {
            ...
            ArrayAdapter<String> adaptador = new ArrayAdapter<>(
                    this, custom_spinner, listaCitas
            );

            adaptador.setDropDownViewResource(R.layout.menupersonalizado);
